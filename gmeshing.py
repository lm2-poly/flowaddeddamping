...
def envelope_gmeshing (envelope_vertices, airfoil_vertices, mesh_size, n = 1, show = False):
    ...
    npoints_big_envelope = (len(big_envelope_vertices)) -1
    npoints_small_envelope = len(small_envelope_vertices) - 1
    
    npoints = npoints_big_envelope + npoints_small_envelope
